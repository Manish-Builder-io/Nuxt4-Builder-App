      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <div class="flex items-center mb-4">
            ...
            <span class="ml-2 text-xl font-bold">{{ props.companyName }}</span>
          </div>
          <p class="text-gray-400 mb-6 max-w-md">
            {{ props.companyDescription }}
          </p>
          <div v-if="props.showSocialLinks" class="flex space-x-4">
...
const props = defineProps({
  ...
  companyDescription: {
    type: String,
    default: 'Build and deploy your website with our powerful visual editor. Create stunning pages without writing code.'
  },
  showSocialLinks: {
    type: Boolean,
    default: true
